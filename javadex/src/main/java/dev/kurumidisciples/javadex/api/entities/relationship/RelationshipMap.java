 ...
 * <p>This class extends {@link HashMap} to map {@link RelationshipType} to {@link List} of {@link RelationshipData}.</p>
 * <p>It is constructed using a {@link JsonArray} which is converted into the map structure.</p>
 */
public class RelationshipMap extends HashMap<RelationshipType, List<RelationshipData>> {
     ...
     * where each key is a {@link RelationshipType} and the value is a list of {@link RelationshipData} related to that type.
     *
